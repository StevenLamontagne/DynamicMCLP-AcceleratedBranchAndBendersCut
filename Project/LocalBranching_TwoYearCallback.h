...
local branching. Uses SepB separation method
*/
...
private:
	...
	*/
	...
	//Attributes for detecting and adding branches
...
public:
	...
	appropriate class functions. Also adds branches at the current node if the context is correct and the branching flag is set
	*/
